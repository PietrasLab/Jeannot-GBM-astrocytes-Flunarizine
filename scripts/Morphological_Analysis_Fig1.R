...
# Description: Pipeline to make morphological analysis on astrocytes used in Fig1.
# The code provided here stands as an example and is the one used to make Fig 1F
# ================================================================
...
custom_pal <- pal_uchicago("default", alpha = 0.5)(9)
IR_pal_ordered <- custom_pal[c(4, 3, 4, 3, 2, 9)]
